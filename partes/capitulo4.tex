...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.7\textwidth}
        \centering
        \includegraphics[width=\textwidth]{partes/ImgJoao/P-CAL-map.png}
        \caption{Nube de puntos del entorno.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.7\textwidth}
        \centering
        \includegraphics[width=\textwidth]{partes/ImgJoao/P-CAL-lanes.png}
        \caption{Canales y caminos de transición.}
    \end{subfigure}
    \break
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{partes/ImgJoao/P-CAL-results.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{partes/ImgJoao/P-CNN.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.2]{partes/ImgJoao/aoa-expert-sample.png}
